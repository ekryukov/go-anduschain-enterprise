...
import (
	...
	"errors"
	"fmt"
	"github.com/anduschain/go-anduschain-enterprise/miner"
	"math"
	"math/big"
	"sync"
	"sync/atomic"
	...
	"github.com/anduschain/go-anduschain-enterprise/consensus/misc"
	...
	"github.com/anduschain/go-anduschain-enterprise/eth/fetcher"
...
func (pm *ProtocolManager) removePeer(id string) {
	...
	log.Debug("Removing Anduschain peer", "peer", id)
...
func (pm *ProtocolManager) Stop() {
	log.Info("Stopping Anduschain protocol")
...
func (pm *ProtocolManager) handle(p *peer) error {
	...
	if err := pm.peers.Register(p); err != nil {
		p.Log().Error("Anduschain peer registration failed", "err", err)
		return err
	}
